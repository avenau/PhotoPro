...
if [ -e $dir ]
then
  mongorestore --host="coen-townson.me" --port="27017" -u "jajac" -p "databasepassword"  --nsInclude="angular-flask-muckaround.*" --dir="$dir" --authenticationDatabase "admin" --drop -d "angular-flask-muckaround"
