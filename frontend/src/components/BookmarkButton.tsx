...
export default function BookmarkButton(props: BookmarkProps) {
    ...
    return (
        <div>
            ...
            <Modal show={showNewCol} onHide={closeNewCol} className="NewCollectionModal">
                <Modal.Header closeButton></Modal.Header>
                <Modal.Title>Create a Collection</Modal.Title>
                <Form onSubmit={handleSubmit}>
                    <Form.Group>
                        <Form.Control onChange={e => setCollection(e.target.value)} placeholder="Enter a name for your new Collection" />
                    </Form.Group>
